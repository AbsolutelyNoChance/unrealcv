...
FString ADataCaptureActor::MakeFilename(FString CameraName, FString DataType, FString FileExtension)
{
	...
	switch (ImageIdType)
	{
	case EImageId::GameFrameId:
		FrameNumber = UVisionBPLib::FrameNumber();
		break;
	case EImageId::RecordedFrameId:
